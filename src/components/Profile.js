...
function Profile(props) {
  ...
  const handleBreed = () => {
    const parentXIndex = props.usersDwarves.findIndex(
      (dwarf) => dwarf._id === selectParentX
    );

    const parentYIndex = props.usersDwarves.findIndex(
      (dwarf) => dwarf._id === selectParentY
    );

    if (parentXIndex !== -1 && parentYIndex !== -1) {
      props.breedDwarvesAndGenerateImage(
        props.usersDwarves[parentXIndex].token_id,
        props.usersDwarves[parentYIndex].token_id
      );
    } else {
        ...
        <>
          {props.breedingLoader ? (
            ...
            >
              ...
              <h5 className="fw-bold mt-4">Breeding...</h5>
            </div>
          ) : (
                ...
                <Tab eventKey="breed" title="Breed">
                  ...
                  <div className="d-flex flex-column align-items-center">
                    <div className="mt-5  d-flex flex-column">
                      ...
                      <Button onClick={handleBreed} className="mt-3">
                        Breed Now!
                      </Button>
                    </div>
                    <div className="mt-5">
...
const mapStateToProps = (state) => {
  return {
    ...
    breedingLoader: state.core.breedingLoader
  };
};
